...
TRANSLATIONS = {
    "en": {
        ...
        "file_menu": "&File",
        "export_pnach_action": "&Export PNACH...",
        "exit_action": "&Exit",
...
You can add descriptions on preceding lines.""",
        ...
        "no_code_to_export_warning_title": "No Code",
        "no_code_to_export_warning_text": "No PNACH code to export.",
        "game_name_input_dialog_title": "Game Name for PNACH",
        "game_name_input_dialog_label": "Enter the game title (e.g., My Game Title):",
        "export_cancelled_title": "Cancelled",
...
This software is provided without warranty.""",
    ...
    "fr": {
        "window_title": "Pcsx2 Pnach Tool",
        "file_menu": "&Fichier",
        "export_pnach_action": "&Exporter PNACH...",
        "exit_action": "&Quitter",
        "options_menu": "&Options",
...
Vous pouvez ajouter des descriptions sur les lignes précédentes.""",
        ...
        "comment_default": "Codes convertis par PyConvert Pnacher",
