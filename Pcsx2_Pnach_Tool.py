...
from PySide6.QtGui import QAction, QPalette, QColor, QIcon # Ajout de QIcon
...
class PyConvertPnacher(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Pcsx2 Pnach Tool") # Modifié le titre de la fenêtre
        self.setWindowIcon(QIcon("Pcsx2 Pnach Tool.ico")) # Chemin mis à jour
